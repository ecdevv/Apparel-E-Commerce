...
const Wishlist = () => {
  ...
  const items: DropdownItem[] = [
    ...
    { name: 'View Wishlist', type: 'component', component: <Link href='/wishlist' className='dropdown-btn'>View Wishlist</Link> },
    // { name: 'Log', type: 'component', component: <button onClick={() => console.log(wishItems)}>Log</button>}
  ]

  return (
    <DropdownButton label={'Wishlist'} forceRef={forceElementRef} items={items} hover={false} orientation={'left'} showPointer={true} classNames={['cart-btn', 'cart-btn-focus']}>
