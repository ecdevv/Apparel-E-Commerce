...
import { generateBlurDataUrl } from '../utility/generateBlurDataUrl';
import './home.css'
...
export default async function Home() {
  const Image1: ImageData = {
    ...
    blurDataUrl: await generateBlurDataUrl('/images/home/carousel-item1.webp'),
  }
  ...
  const Image2: ImageData = {
    ...
    blurDataUrl: await generateBlurDataUrl('/images/home/carousel-item2.webp'),
  }
  ...
  const Image3: ImageData = {
    ...
    blurDataUrl: await generateBlurDataUrl('/images/home/carousel-item3.webp'),
  }
  ...
  const Image4: ImageData = {
    ...
    blurDataUrl: await generateBlurDataUrl('/images/home/carousel-item4.webp'),
  }
